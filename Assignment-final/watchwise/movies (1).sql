...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2025 at 01:48 AM
...
(1, 'Interstellar', 'Thriller', 2014, 'Amazon Prime', 'Matthew McConaughey, Anne Hathaway', 'When Earth becomes uninhabitable in the future, a farmer and ex-NASA pilot, Joseph Cooper, is tasked to pilot a spacecraft, along with a team of researchers, to find a new planet for humans.', 8.7, 'uploads/url1.jpg'),
(2, 'Abigail', 'Horror, Comedy', 2024, 'Amazon Prime', 'Angus Cloud, Melissa Barrera', 'After a group of criminals kidnap the ballerina daughter of a powerful underworld figure, they retreat to an isolated mansion, unaware that they are locked inside with no normal little girl.', 6.6, 'uploads/url2.jpg'),
(3, 'Tenet', 'Action, Thriller', 2020, 'Amazon Prime', 'Elizabeth Debicki, John David Washington', 'Armed with only the word \"Tenet,\" and fighting for the survival of the entire world, CIA operative, The Protagonist, journeys through a twilight world of international espionage on a global mission that unfolds beyond real time.', 7.3, 'uploads/url3.jpg'),
(4, 'Spider-Man: Homecoming', 'Action, Sci-fi', 2017, 'Amazon Prime', 'Tom Holland, Zendaya', 'Peter Parker tries to stop Adrian (The Vulture) Toomes from selling weapons made with advanced Chitauri technology while trying to balance his life as an ordinary high school student.', 7.4, 'uploads/url4.jpg'),
...
(6, 'Fast and Furious: Tokyo Drift', 'Action, Crime', 2006, 'Amazon Prime', 'Lucas Black, Nathalie Kelley', 'A teenager becomes a major competitor in the world of drift racing after moving in with his father in Tokyo to avoid a jail sentence in America.', 6.1, 'uploads/url6.jpg'),
(7, 'Twilight', 'Romance, Fantasy', 2008, 'Netflix', 'Kristen Stewart, Robert Pattinson', 'When Bella Swan moves to a small town in the Pacific Northwest, she falls in love with Edward Cullen, a mysterious classmate who reveals himself to be a 108-year-old vampire.', 5.3, 'uploads/url7.jpg'),
(8, 'Pirates of the Caribbean', 'Adventure, Action', 2003, 'Disney+', 'Johnny Depp, Keira Knightley', 'Blacksmith Will Turner teams up with eccentric pirate \"Captain\" Jack Sparrow to save Elizabeth Swann, the governors daughter and his love, from Jacks former pirate allies, who are now undead.', 8.1, 'uploads/url8.jpg'),
(10, 'men in black', 'Action, Sci-fi', 1997, 'Netflix', 'Tommy Lee Jones, Will Smith', 'James, an NYC cop, is hired by Agent K of a secret government agency that monitors extraterrestrial life on Earth. Together, they must recover an item that has been stolen by an intergalactic villain.', 7.3, 'uploads/url10.jpg'),
(11, 'Titanic', 'Romance, Adventure', 1997, 'Netflix', 'Kate Winslet, Leonardo DiCaprio', 'A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.', 7.9, 'uploads/url11.jpg');
...
(1, 'Adil Surve', 'asurve786@hotmail.com', '5f4dcc3b5aa765d61d8327deb882cf99'),
(2, 'isha shah', 'ishashah@hotmail.com', '5f4dcc3b5aa765d61d8327deb882cf99'),
(3, 'Jinal Patel', 'jinalpatel@hotmail.com', '5f4dcc3b5aa765d61d8327deb882cf99');
